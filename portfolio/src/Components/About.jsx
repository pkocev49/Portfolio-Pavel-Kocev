        ...
        <div className=" p-5 md:flex md:justify-around md:w-full xl:w-[1100px] 2xl:w-[1400px] 8xl:w-[1500px] ">
          <div className="w-[300px] xl:text-1xl xl:w-[400px] 4xl:text-1xl ">
            <p className="text-white ">
              ...
              began with a curiosity for problem-solving and a love for turning
              creative concepts into functional, user-centric digital solutions.
              With a keen eye for detail and a commitment to delivering
              excellence, I specialize in crafting seamless web applications
              that not only meet but exceed expectations.
            </p>
            <p className="text-white mt-[20px]">
              I thrive on the continuous evolution of web technologies ensuring
              that my skill set remains cutting-edge in this dynamic industry.
              From front-end design to back-end functionality, I bring a
              holistic approach to every project, aiming to create immersive and
              impactful online experiences. Let's collaborate to transform your
              ideas into a visually stunning and technically robust digital
              presence. Explore my portfolio to see how we can build something
              remarkable together.
            </p>
